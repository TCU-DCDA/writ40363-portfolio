...
function displayWeather(weather) {
    ...
    weatherDisplay.innerHTML = `
        ${weather.cityImage ? `<img src="${weather.cityImage}" alt="${weather.location}" class="city-image">` : ''}
...
function displayRandomQuote() {
  ...
  quotesDisplay.innerHTML = `
    <div class="quote-card">
      <img src="${quote.image}" alt="${quote.author}" class="quote-author-image" onerror="this.style.display='none'">
